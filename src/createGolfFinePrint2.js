...
const imageUrl = 'https://i.ibb.co/TDpcChjh/Aerial-Digital-Painting-Of-A-Lush-Golf-Course.png';

try {
  const uploaded = await printify.uploadImage({ file_name: 'golf-course-2.png', url: imageUrl });
