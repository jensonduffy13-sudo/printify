...
const imageUrl = 'https://i.ibb.co/cSMzqMDX/Vibrant-Retro-Poster-For-Aprol-Spritz-Cocktail-2.png';

try {
  const uploaded = await printify.uploadImage({ file_name: 'retro-spritz-poster-2.png', url: imageUrl });
  console.log('Image uploaded:', uploaded.id);

  const product = {
    title: 'Retro Spritz Cocktail Fine Art Print Vol.2 | Vintage Bar Wall Art | Kitchen Poster | Cocktail Gift | Bar Cart Decor',
