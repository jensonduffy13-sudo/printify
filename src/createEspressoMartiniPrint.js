...
const imageUrl = 'https://i.ibb.co/4ZLXvVMB/Stylized-Espresso-Martini-Recipe-Poster-in-Earthy-Tones.png';

try {
  const uploaded = await printify.uploadImage({ file_name: 'espresso-martini-poster.png', url: imageUrl });
  console.log('Image uploaded:', uploaded.id);

  const product = {
    title: 'Espresso Martini Recipe Fine Art Print | Bar Wall Art | Coffee Cocktail Poster | Kitchen Decor | Cocktail Gift',
    description: 'A stylish espresso martini recipe poster in warm earthy tones — the perfect blend of coffee culture and cocktail sophistication. Ideal for kitchens, bars, dining rooms, and coffee lovers alike.\n\nPrinted on premium fine art matte paper with archival-quality, fade-resistant inks for a gallery-worthy finish.\n\n• Premium fine art matte paper\n• Vivid, fade-resistant archival inks\n• Ships rolled in a protective tube\n• Available in multiple sizes\n• Ready to frame',
