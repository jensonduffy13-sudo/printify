...
const imageUrl = 'https://i.ibb.co/1tdn7DrX/Lewis-Hamilton-Sports-Poster-Celebrating-Ferrari-Move.png';

try {
  const uploaded = await printify.uploadImage({ file_name: 'lewis-hamilton.png', url: imageUrl });
  console.log('Image uploaded:', uploaded.id);

  const product = {
    title: 'Lewis Hamilton Ferrari F1 Fine Art Print | Formula 1 Wall Art | Motorsport Poster | Race Fan Gift',
    description: 'A bold portrait of Lewis Hamilton celebrating his iconic move to Ferrari — a defining moment in Formula 1 history. Perfect for any F1 fan, bedroom wall, home office, or garage.\n\nPrinted on premium fine art matte paper with archival-quality, fade-resistant inks for a gallery-worthy finish.\n\n• Premium fine art matte paper\n• Vivid, fade-resistant archival inks\n• Ships rolled in a protective tube\n• Available in multiple sizes\n• Ready to frame',
